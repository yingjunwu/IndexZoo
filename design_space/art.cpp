    ...
    while (n) {
        ...
        if (IS_LEAF(n)) {
            ...
            if (!leaf_matches(l, key, key_len)) {
                ...
                std::cout << "key_len = " << key_len << " " << depth << std::endl;
        ...
        if (n->partial_len) {
            ...
            std::cout << "before: depth = " << depth << std::endl;
            std::cout << "partial len = " << n->partial_len << std::endl;
        ...
        std::cout << "key[depth]= " << key[depth] << std::endl;
        n = (child) ? *child : NULL;
        depth++;
    }
    return;
...
static bool recursive_insert(art_node *n, art_node **ref, const unsigned char *key, int key_len, ValueT value, int depth) {
    ...
    if (IS_LEAF(n)) {
        ...
        std::cout << "partial len = " << new_node->n.partial_len << std::endl;
